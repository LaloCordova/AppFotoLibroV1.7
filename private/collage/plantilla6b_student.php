 ...
 <!DOCTYPE html>
  ...
  <style>
    ...
    .card {
      ...
      background-image: url('plantillas/Pagina13.png');
    ...
    .help{
      background-image: url('plantillas/Pagina_6c.png');
      background-repeat: no-repeat;
  ...
  <body>
      ...
      <div class="pos-f-t">
        ...
        <nav class="navbar navbar-light bg-light shadow p-3 mb-5 bg-white scale-in-ver-bottom">
          ...
          <a href="../views/editpageUser.php"  class="btn btn-outline-success" type="submit" id="back"><svg
      ...
      <div class="card" id="saver">
        <div class="bg-card-10">
          <div class="img-div-container-10-1">
            <div class="img-div-10-1 img-def">
              <form method="post">
                <label for="upload_image1">
                  <div class="help">
                  <img src="placeholders/imgp6b.png" id="uploaded_image1">
            ...
            <form method="post">
                <label for="upload_image2">
                  <div class="help">
                  <img src="placeholders/imgp6b.png" id="uploaded_image2">
          ...
          <div class="img-div-container-10-1">
            ...
            <form method="post">
                <label for="upload_image3">
                  <div class="help">
                  <img src="placeholders/imgp6b.png" id="uploaded_image3">
            ...
            <form method="post">
                <label for="upload_image4">
                  <div class="help">
                  <img src="placeholders/imgp6b.png" id="uploaded_image4">
                  <input type="file" name="image" class="image" id="upload_image4" style="display: none" />
                  </div>
                </label>
          ...
          <div class="img-div-container-10-1">
            ...
            <form method="post">
                <label for="upload_image5">
                  <div class="help">
                  <img src="placeholders/imgp6b.png" id="uploaded_image5">
                  <input type="file" name="image" class="image" id="upload_image5" style="display: none" />
                  </div>
                </label>
            ...
            <form method="post">
                <label for="upload_image6">
                  <div class="help">
                  <img src="placeholders/imgp6b.png" id="uploaded_image6">
                  <input type="file" name="image" class="image" id="upload_image6" style="display: none" />
                  </div>
                </label>
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-footer">
                            <button type="button" class="btn btn-primary" id="ready"
                                onClick="window.location.assign('../views/editpageUser.php')">¡Listo, Haz click para
                                volver!</button>
                        </div>
                    </div>
                </div>
  ...
  $("#crop").click(function () {
    ...
    $("#saveScreenshot").click(function () {
            ...
            html2canvas(saver, {
                ...
                $.ajax({
                    url: "saveScreenshot_student.php",
                    method: "POST",
                    data: {
