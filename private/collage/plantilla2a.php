            ...
            <div class="card" id="saver">
                <div class="bg-card-2">
                    ...
                    <div class="container d-flex justify-content-center">
                        <input id="mi_campo" class="input-group input-group-sm mb-3" maxlength="50" type="text"
                            placeholder="Ingresa el texto de la foto (MAX 50)" style="background-color: rgba(0, 0, 0, 0);
