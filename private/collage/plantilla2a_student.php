  ...
  <body>
    ...
    <div class="container" align="center">
      ...
      <div class="card" id="saver">
        <div class="bg-card-2">
          <div id="formulario" class="img-div img-def">
            <form method="post">
              <label for="upload_image1">
                <img src="placeholders/imgp2a.png" id="uploaded_image1" />
                <input type="file" name="image" class="image" id="upload_image1" style="display: none" />
              </label>
            </form>
          </div>
          <div class="container d-flex justify-content-center">
            <input class="input-group input-group-sm mb-3" maxlength="50" type="text"placeholder="Ingresa el texto de la foto (MAX 50)" style="background-color: rgba(0, 0, 0, 0);
              border-color: rgba(0, 0, 0, 0);
              z-index:2; position:absolute; margin-top:-3%; text-align: center;
              font-size:130%; text-align:center;">
          </div>
          <div id="formulario" class="img-div img-def">
            <form method="post">
              <label for="upload_image2">
                <img src="placeholders/imgp2a.png" id="uploaded_image2" />
