...
if ($filas['student_rol'] == '3') {
  ...
  <style>
    ...
    .bg-card-6 {
      background-image: url('plantillas/Pagina15.png');
  ...
  <body>
    ...
    <div class="container" align="center">
      ...
      <div class="card" id="saver">
        <div class="bg-card-6">
          <div class="img-div-container-6">
            <div class="img-div-6-2 img-def">
              <form method="post">
                <label for="upload_image1">
                  <img src="placeholders/imgp3c2.png" id="uploaded_image1">
            ...
            <div class="img-div-6-2 img-def">
              <form method="post">
                <label for="upload_image2">
                  <img src="placeholders/imgp3c2.png" id="uploaded_image2">
          ...
          <div class="img-div-6-1 img-def">
          
            <form method="post">
              <label for="upload_image3">
                <img src="placeholders/imgp3c2.png" id="uploaded_image3">
        ...
        <div class="container d-flex justify-content-center">
              <textarea rows="3" cols="50" class="form-check-input input-group input-group-sm mb-3" maxlength="40" type="text"placeholder="Ingresa el texto de la foto (MAX 40)" style="background-color: rgba(0, 0, 0, 0);
              border-color: rgba(0, 0, 0, 0);
              z-index:5; position:relative; margin-top:-35%; margin-left:58%; text-align: center;
               font-size:140%; text-align:center; width:100%; "></textarea>
              </div>
      </div>
