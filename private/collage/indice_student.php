        ...
        <div class="pos-f-t">
            ...
            <nav class="navbar navbar-light bg-light shadow p-3 mb-5 bg-white scale-in-ver-bottom">
                ...
                <a class="navbar-brand" href="#">
                    <img src="../../public/img/icons/Logo.png" width="30" height="30"
                        class="align-top justify-content-center" alt="">
                    GaDo Studio
                </a>
                <a href="../views/editpageUser.php" class="btn btn-outline-success" type="submit"><svg
                    ...
                    <div class="col-sm-0 mb-3 mb-sm-0">
                        <div class="card" style="width: 10rem;">
                            <div class="card-body">
                                ...
                                <a href="plantilla1_student.php" class="btn btn-primary">Usar</a>
                            </div>
                        </div>
                    </div>
                    <!-- Carta-->
                    <div class="col-sm-0 mb-3 mb-sm-0">
                        <div class="card" style="width: 10rem;">
                            <div class="card-body">
                                ...
                                <a href="plantilla2a_student.php" class="btn btn-primary">Usar</a>
                            </div>
                        </div>
                    </div>
                    <!-- Carta-->
                    ...
                    <div class="col-sm-0 mb-3 mb-sm-0">
                        <div class="card" style="width: 10rem;">
                            <div class="card-body">
                                ...
                                <a href="plantilla2b_student.php" class="btn btn-primary">Usar</a>
                            </div>
                        </div>
                    </div>
                    <!-- Carta-->
                    ...
                    <div class="col-sm-0 mb-3 mb-sm-0">
                        <div class="card" style="width: 10rem;">
                            <div class="card-body">
                                ...
                                <a href="plantilla3a_student.php" class="btn btn-primary">Usar</a>
                            </div>
                        </div>
                    </div>
                    <!-- Carta-->
                    ...
                    <div class="col-sm-0 mb-3 mb-sm-0">
                        <div class="card" style="width: 10rem;">
                            <div class="card-body">
                                ...
                                <a href="plantilla3b_student.php" class="btn btn-primary">Usar</a>
                            </div>
                        </div>
                    </div>
                    <!-- Carta-->
                    ...
                    <div class="col-sm-0 mb-3 mb-sm-0">
                        <div class="card" style="width: 10rem;">
                            <div class="card-body">
                                ...
                                <a href="plantilla3c_student.php" class="btn btn-primary">Usar</a>
                            </div>
                        </div>
                    </div>
                    <!-- Carta-->
                    ...
                    <div class="col-sm-0 mb-3 mb-sm-0">
                        <div class="card" style="width: 10rem;">
                            <div class="card-body">
                                ...
                                <a href="plantilla3d_student.php" class="btn btn-primary">Usar</a>
                            </div>
                        </div>
                    </div>
                    <!-- Carta-->
                    ...
                    <div class="col-sm-0 mb-3 mb-sm-0">
                        <div class="card" style="width: 10rem;">
                            <div class="card-body">
                                ...
                                <a href="plantilla4a_student.php" class="btn btn-primary">Usar</a>
                            </div>
                        </div>
                    </div>
                    <!-- Carta-->
                    ...
                    <div class="col-sm-0 mb-3 mb-sm-0">
                        <div class="card" style="width: 10rem;">
                            <div class="card-body">
                                ...
                                <a href="plantilla5a_student.php" class="btn btn-primary">Usar</a>
                            </div>
                        </div>
                    </div>
                    <!-- Carta-->
                    ...
                    <div class="col-sm-0 mb-3 mb-sm-0">
                        <div class="card" style="width: 10rem;">
                            <div class="card-body">
                                ...
                                <a href="plantilla6a_student.php" class="btn btn-primary">Usar</a>
                            </div>
                        </div>
                    </div>
                    <!-- Carta-->
                    ...
                    <div class="col-sm-0 mb-3 mb-sm-0">
                        <div class="card" style="width: 10rem;">
                            <div class="card-body">
                                ...
                                <a href="plantilla6b_student.php" class="btn btn-primary">Usar</a>
                            </div>
                        </div>
                    </div>
                    <!-- Carta-->
