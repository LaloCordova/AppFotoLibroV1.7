...
if ($filas['student_rol'] == '3') {
  ...
  <style>
    ...
    .bg-card-9 .img-div-9-1 {
      width: 95%;
      height: 90%;
      margin-left:7%;
    }

    .img-div-container-9-2 {
      display: grid;
  ...
  <body>
    ...
    <div class="container" align="center">
      ...
      <div class="card" id="saver">
        <div class="bg-card-9">
          <div class="img-div-container-9-1">
            <div class="img-div-9-1 img-def">
              <form method="post">
                <label for="upload_image1">
                  <img src="placeholders/imgp5a.png" id="uploaded_image1">
            ...
            <div class="img-div-9-1 img-def">
              <form method="post">
                <label for="upload_image2">
                  <img src="placeholders/imgp5a.png" id="uploaded_image2">
          ...
          <div class="img-div-container-9-2">
            <div class="img-div-9-2 img-def">
              <form method="post">
                <label for="upload_image3">
                  <img src="placeholders/imgp5a.png" id="uploaded_image3">
            ...
            <div class="img-div-9-1 img-def">
              <form method="post">
                <label for="upload_image4">
                  <img src="placeholders/imgp5a.png" id="uploaded_image4">
            ...
            <div class="img-div-9-1 img-def">
              <form method="post">
                <label for="upload_image5">
                  <img src="placeholders/imgp5a.png" id="uploaded_image5">
