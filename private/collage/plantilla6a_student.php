...
if ($filas['student_rol'] == '3') {
 ...
 <!DOCTYPE html>
  ...
  <style>
    ...
    .bg-card-10 {
      background-image: url('plantillas/Pagina12.png');
            ...
            <div class="img-div-10-1 img-def">
              <form method="post">
                <label for="upload_image1">
                  <img src="placeholders/imgp6a.png" id="uploaded_image1">
            ...
            <div class="img-div-10-1 img-def">
              <form method="post">
                <label for="upload_image2">
                  <img src="placeholders/imgp6a.png" id="uploaded_image2">
            ...
            <div class="img-div-10-1 img-def">
              <form method="post">
                <label for="upload_image3">
                  <img src="placeholders/imgp6a.png" id="uploaded_image3">
            ...
            <div class="img-div-10-1 img-def">
              <form method="post">
                <label for="upload_image4">
                  <img src="placeholders/imgp6a.png" id="uploaded_image4">
            ...
            <div class="img-div-10-1 img-def">
              <form method="post">
                <label for="upload_image5">
                  <img src="placeholders/imgp6a.png" id="uploaded_image5">
            ...
            <div class="img-div-10-1 img-def">
              <form method="post">
                <label for="upload_image6">
                  <img src="placeholders/imgp6a.png" id="uploaded_image6">
