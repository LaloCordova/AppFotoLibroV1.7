  ...
  <style>
    ...
    img {
      ...
      border-top: 5px solid #000000;
            border-right: 5px solid #9c8383;
            border-bottom: 5px solid #9c8383;
    ...
    .bg-card-3 {
      background-image: url('plantillas/Pagina14.png');
  ...
  <body>
    ...
    <div class="container" align="center">
      ...
      <div class="card" id="saver">
        <div class="bg-card-3">
          <div class="img-div-3-1 img-def">
            <form class="" method="post">
              <label for="upload_image1">
                <img src="placeholders/imgp2b.png" id="uploaded_image1" />
                <input type="file" name="image" class="image" id="upload_image1" style="display: none" />
              </label>
              <div class="container d-flex justify-content-center">
              <input class="input-group input-group-sm mb-3" maxlength="15" type="text"placeholder="Ingresa el texto de la foto (MAX 30)" style="background-color: rgba(0, 0, 0, 0);
              border-color: rgba(0, 0, 0, 0);
              z-index:3; position:relative; margin-top:5%; text-align: center;
               font-size:130%; text-align:center; width:100%;">
              </div>
            </form>
          </div>
          <div class="img-div-3-2 img-def">
          <div class="container d-flex justify-content-center">
              <input class="input-group input-group-sm mb-3" maxlength="15" type="text"placeholder="Ingresa el texto de la foto (MAX 30)" style="background-color: rgba(0, 0, 0, 0);
              border-color: rgba(0, 0, 0, 0);
              z-index:3; position:relative; margin-top:-20%; text-align: center;
               font-size:130%; text-align:center; width:100%;">
              </div>
            <form method="post">
              <label for="upload_image2">
                <img src="placeholders/imgp2b.png" id="uploaded_image2">
