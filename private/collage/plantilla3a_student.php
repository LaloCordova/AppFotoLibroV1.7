...
if ($filas['student_rol'] == '3') {
  ...
  <style>
    ...
    .bg-card-4 {
      background-image: url('plantillas/Pagina17.png');
  ...
  <body>
      ...
      <div class="card" id="saver">
        <div class="bg-card-4">
          <div class="img-div-4-1 img-def">
            <form method="post">
              <label for="upload_image1">
                <img src="placeholders/imgp3a1.png" id="uploaded_image1">
            ...
            <input class="input-group input-group-sm mb-3" maxlength="30" type="text"placeholder="Ingresa el texto de la foto (MAX 30)" style="background-color: rgba(0, 0, 0, 0);
              ...
              z-index:3; position:relative; margin-top:8%; text-align: center;
              font-size:140%; text-align:center;">
          </div>
          </div>
          <div class="img-div-container-4">
            <div class="img-div-4-2 img-def">
              <form method="post">
            ...
            <div class="img-div-4-2 img-def">
              <form method="post">
                <label for="upload_image3">
                  <img src="placeholders/imgp3a2.png" id="uploaded_image3">
