        ...
        <div class="bg-card-7">
          ...
          <div class="img-div-7-1 img-def">
            <form method="post">
              ...
              <textarea rows="5" cols="50" class="form-check-input input-group input-group-sm mb-3" maxlength="60" type="text"placeholder="Ingresa el texto de la foto (MAX 60)" style="background-color: rgba(0, 0, 0, 0);
              border-color: rgba(0, 0, 0, 0);
              z-index:5; position:relative; margin-top:5%; margin-left:5%; text-align: center;
               font-size:130%; text-align:center; width:100%; "></textarea>
              </div>
            </form>
          </div>
          <div class="img-div-container-7">
            <div class="img-div-7-2 img-def">
              <form method="post">
