  ...
  <body>
    ...
    <div class="container" align="center">
      ...
      <div class="card" id="saver">
        <div class="bg-card-8">
          <div class="img-div-container-8-1">
            <div class="img-div-8-1 img-def">
              <form method="post">
                <label for="upload_image1">
                  <img src="placeholders/imgp4a.png" id="uploaded_image1">
            ...
            <div class="img-div-8-1 img-def">
              <form method="post">
                <label for="upload_image2">
                  <img src="placeholders/imgp4a.png" id="uploaded_image2">
          ...
          <div class="img-div-container-8-2">
            <div class="img-div-8-2 img-def">
              <form method="post">
                <label for="upload_image3">
                  <img src="placeholders/imgp4a.png" id="uploaded_image3">
            ...
            <div class="img-div-8-2 img-def">
              <form method="post">
                <label for="upload_image4">
                  <img src="placeholders/imgp4a.png" id="uploaded_image4">
