  ...
  <body>
    <div class="pos-f-t">
      ...
      <nav class="navbar navbar-light bg-light shadow p-3 mb-5 bg-white scale-in-ver-bottom">
        ...
        <a class="btn btn-outline-success" type="submit" href="clientsPage.php"><svg xmlns="http://www.w3.org/2000/svg"
    ...
    <div class="container swing-in-top-fwd2">
      <ul class="bxslider">
        ...
        $resultadou = mysqli_query($link, $sql);
        $row = mysqli_fetch_array($resultadou);

        $valor2 = $row['total_pages'];
    ...
    <div class="float-child3">
      ...
      <div style="display: flex; justify-content: center; align-items: center; height: 100px;">
        <div class="progress" style="width: 60%;">
          <div class="progress-bar progress-bar-striped progress-bar-animated" aria-label="Progress Label"
            role="progressbar" style="width: <?php echo $porcentaje; ?>%;" aria-valuenow="<?php echo $porcentaje; ?>"
            aria-valuemin="0" aria-valuemax="100"> <?php echo $contar . '/' . $valor2; ?></div>
        </div>
      </div>
      ...
      <div class="container" style="width:40%">
        ...
        <div class="row d-flex justify-content-center btn-group  scale-in-center" id="mi-imagen">
        <?php echo "<a class='btn btn-primary' href='../../private/collage/descargar_zip.php?id=" . $id . "'>Descargar en PNG</a>" ?><br>
        </div>
        <br><br>

        <div class="row d-flex justify-content-center btn-group scale-in-center" id="mi-imagen">
          <?php echo "<a class='btn btn-danger' href='../../private/collage/incidencias.php?id=" . $id . "'>Eliminar incidencias</a>" ?><br>
        </div><br><br>
      </div>
