  ...
  <body>
    <div class="pos-f-t">
      ...
      <nav class="navbar navbar-light bg-light shadow p-3 mb-5 bg-white scale-in-ver-bottom">
        ...
        <a class="btn btn-outline-success" type="submit" href="mainUser.php"><svg xmlns="http://www.w3.org/2000/svg"
    ...
    $folder = '../collage/images/' . $filas['id_user_student'] . '/pages';
    ...
    <div class="float-child3">
      ...
      <div style="display: flex; justify-content: center; align-items: center; height: 100px;">
        ...
        <div class="intern3 scale-in-center" id="mi-imagen">
          <a href="../collage/indice_student.php"><img src="../../public/img/icons/editIcon.png" alt="" width="50px"
              height="50px"></a>
        ...
        <div class="intern5 scale-in-center">
          <a href="faquser.php"><img src="../../public/img/icons/Ayudaicon.png" alt="" width="50px" height="50px"></a>
