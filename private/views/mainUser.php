...
if ($filas['student_rol'] == 3) {
  ...
  <body>
    ...
    <div class="float-child1 swing-in-top-fwd2">
      ...
      <div class="container blue tracking-in-contract-bck">
        
        <!-- BOTONES DE ACCION -->
        <div class="float-child3">
          <div class="green">
            <div class="intern3 scale-in-center">
              <a href="editpageUser.php"><img src="../../public/img/icons/galeryIcon.png" alt="" width="50px" height="50px"></a>
              <p style="color: black;">Ver Fotolibro</p>
            </div>
            <div class="intern3 scale-in-center" id="mi-imagen">
                <a href="../collage/incidencias_user.php"><img src="../../public/img/icons/deleteIcon.png" alt="" width="50px"
                     height="50px"></a>
                <p style="color: black;">Eliminar Incidencias</p>
        </div>
            <div class="intern5 scale-in-center">
              <a href="faquser.php"><img src="../../public/img/icons/Ayudaicon.png" alt="" width="50px"
                  height="50px"></a>
